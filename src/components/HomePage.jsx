        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-8 flex justify-center space-x-4 animate-fadeIn">
              <button className="px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:text-lg transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg">
                Explore Projects
              </button>
              <button className="px-6 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-indigo-100 hover:bg-indigo-200 dark:text-indigo-300 dark:bg-gray-800 dark:hover:bg-gray-700 md:text-lg transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg">
                Learn More
              </button>
            </div>
          </div>
